...
namespace Sayac_Proje
{
    public partial class FrmAlis : Form
    {
        ...
        private void BtnListele_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("select ALISID,URUNAD,BFIYATI,MIKTAR,STK,FATURABEDELI,ODEME,KALANBAKIYE,TEDFIRMA from Tbl_Alis INNER JOIN Tbl_Tedarikci ON Tbl_Alis.TEDARIKCI=Tbl_Tedarikci.TEDID INNER JOIN Tbl_Urunn ON Tbl_Alis.URNAD=Tbl_Urunn.URUNID ORDER BY ALISID DESC ", conn);
            conn.Open();
            da.Fill(dt);
        ...
        private void BtnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            komut.Parameters.AddWithValue("@p7", Convert.ToDecimal(TxtKalanBakiye.Text));
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            CmbUrunAdi.Text = dataGridView1.Rows[secilen].Cells[1].Value.ToString();
            CmbBirimFiyati.Text = dataGridView1.Rows[secilen].Cells[2].Value.ToString();
            TxtMiktarLT.Text = dataGridView1.Rows[secilen].Cells[3].Value.ToString();
            CmbTedarikci.Text = dataGridView1.Rows[secilen].Cells[8].Value.ToString();
            CmbStok.Text = dataGridView1.Rows[secilen].Cells[4].Value.ToString();
            TxtFaturaBedeli.Text = dataGridView1.Rows[secilen].Cells[5].Value.ToString();
            TxtOdeme.Text = dataGridView1.Rows[secilen].Cells[6].Value.ToString();
            TxtKalanBakiye.Text = dataGridView1.Rows[secilen].Cells[7].Value.ToString();
        ...
        private void BtnEkle_Click(object sender, EventArgs e)
        {
            ...
            tedarikci = int.Parse(CmbTedarikci.SelectedValue.ToString());
            SqlConnection conn = new SqlConnection(bgl.Adres);
            conn.Open(); SqlCommand komut = new SqlCommand("insert into Tbl_Alis(URNAD,BFIYATI,MIKTAR,STK,FATURABEDELI,ODEME,KALANBAKIYE,TEDARIKCI) values(@p1,@p2,@p3,@p4,@p5,@p6,@p7,@p8)", conn);
            komut.Parameters.AddWithValue("@p1", urun);
            komut.Parameters.AddWithValue("@p2", Convert.ToDecimal(CmbBirimFiyati.Text));
            komut.Parameters.AddWithValue("@p3", Convert.ToDecimal(TxtMiktarLT.Text));
            komut.Parameters.AddWithValue("@p4", Convert.ToDecimal(CmbStok.Text));
